...
{
    public class BarberUnitInputExample : IExamplesProvider<BarberUnitInput>
    {
        public BarberUnitInput GetExamples()
        {
            ...
            return new BarberUnitInput("João cortes - Araxá", "Macapá", "AP", "Avenida Primeira", "230", "", "68903-860", workingHours);
        }
    }
}
