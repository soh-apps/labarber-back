...
namespace LaBarber.Infra.Migrations
{
    ...
    [Migration("20240601224822_add-initial-admin-data")]
    partial class addinitialadmindata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.AppUser.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CredentialId = 1,
                            Name = "admin",
                            RegisterDate = new DateTime(2024, 6, 1, 22, 48, 21, 827, DateTimeKind.Utc).AddTicks(9665),
                            Status = 1
                        });
                });
