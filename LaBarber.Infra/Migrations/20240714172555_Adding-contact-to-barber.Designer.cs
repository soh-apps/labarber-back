...
namespace LaBarber.Infra.Migrations
{
    ...
    [Migration("20240714172555_Adding-contact-to-barber")]
    partial class Addingcontacttobarber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.AppUser.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CredentialId = 1,
                            Name = "admin",
                            RegisterDate = new DateTime(2024, 7, 14, 17, 25, 55, 631, DateTimeKind.Utc).AddTicks(2478),
                            Status = 1
                        });
                });
