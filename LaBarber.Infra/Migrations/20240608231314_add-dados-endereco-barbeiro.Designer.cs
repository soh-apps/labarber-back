...
namespace LaBarber.Infra.Migrations
{
    ...
    [Migration("20240608231314_add-dados-endereco-barbeiro")]
    partial class adddadosenderecobarbeiro
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.AppUser.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CredentialId = 1,
                            Name = "admin",
                            RegisterDate = new DateTime(2024, 6, 8, 23, 13, 14, 236, DateTimeKind.Utc).AddTicks(4945),
                            Status = 1
                        });
                });
