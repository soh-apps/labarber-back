...
namespace LaBarber.Infra.Migrations
{
    ...
    [Migration("20240721224133_AdicionarEmpresaNoPlanoDoCliente")]
    partial class AdicionarEmpresaNoPlanoDoCliente
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.AppUser.AppUserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CredentialId = 1,
                            Name = "admin",
                            RegisterDate = new DateTime(2024, 7, 21, 22, 41, 33, 130, DateTimeKind.Utc).AddTicks(1409),
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.BarberUnit.BarberUnitAvailabilityEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.BarberUnit.BarberUnitEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LaBarber.Domain.Entities.Appointment.AppointmentEntity", b =>
                {
                    ...
                    b.HasOne("LaBarber.Domain.Entities.BarberUnit.BarberUnitEntity", "BarberUnit")
                        .WithMany()
